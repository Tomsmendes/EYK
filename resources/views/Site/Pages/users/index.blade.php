                ...
                <div class="modal-body">
                    <form id="userForm" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="vc_nome" name="vc_nome" value="{{ old('vc_nome') }}" required>
                            @error('vc_nome')
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" id="fc_id" name="fc_id" required>
                                ...
                                @foreach ($funcoes as $funcao)
                                    <option value="{{ $funcao->id }}" {{ old('fc_id') == $funcao->id ? 'selected' : '' }}>{{ $funcao->name_fc }}</option>
                                @endforeach
                            </select>
                            @error('fc_id')
                                <div class="text-danger">{{ $message }}</div>
