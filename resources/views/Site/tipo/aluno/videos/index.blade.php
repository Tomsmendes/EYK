...
<div class="container mt-5">
        ...
        @forelse($videos as $video)
            <div class="col-md-4 mb-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">{{ $video->titulo }} por {{ $video->user->vc_nome ?? 'Usuário' }}</h5>
                        <p class="text-muted video-duration" id="duration-{{ $video->id }}">⏳ Carregando...</p>
                        <!-- Vídeo escondido só para calcular duração -->
    ...
    <a href="{{ route('casa.index') }}" class="btn btn-secondary mt-3">Casa</a>
</div>
